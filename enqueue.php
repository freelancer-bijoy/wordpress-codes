...
function theme_css_js_enqueue() {
	...
	// scrollup js
	wp_enqueue_script( 'example-js', get_template_directory_uri() . '/js/example.js', array('jquery'), '1.0.0', true );
	

	// gmaps
	wp_enqueue_script( 'gmaps-link-js', get_template_directory_uri() . 'https://maps.googleapis.com/maps/api/js?key=AIzaSyB4RM7zOgOKq6n2fv407hX28xiL-M6vLdY', array('jquery'), '1.0.0', true );
	wp_enqueue_script( 'gmaps-name', get_template_directory_uri() . '/assets/js/gmaps.js', array('jquery'), '1.0.0', true );
	...
	// jquery counterup
	wp_enqueue_script( 'counter-js', get_template_directory_uri() . '/assets/js/counterup.min.js', array('jquery'), '1.0.0', true );
	// owl.carousel.min.js
	...
	wp_enqueue_script( 'rs-themepunch-tools-js', get_template_directory_uri() . '/rs-plugin/js/jquery.themepunch.tools.min.js', array('jquery'), '1.0.0', true );
	wp_enqueue_script( 'rs-themepunch-js', get_template_directory_uri() . '/rs-plugin/js/jquery.themepunch.revolution.min.js', array('jquery'), '1.0.0', true );


	// slider revolution 5.0 extensions
	wp_enqueue_script( 'rs-actions-js', get_template_directory_uri() . '/rs-plugin/js/extensions/revolution.extension.actions.min.js', array('jquery'), '1.0.0', true );
	wp_enqueue_script( 'rs-kenburn-js', get_template_directory_uri() . '/rs-plugin/js/extensions/revolution.extension.kenburn.min.js', array('jquery'), '1.0.0', true );
	wp_enqueue_script( 'rs-layeranimation-js', get_template_directory_uri() . '/rs-plugin/js/extensions/revolution.extension.layeranimation.min.js', array('jquery'), '1.0.0', true );
	wp_enqueue_script( 'rs-migration-js', get_template_directory_uri() . '/rs-plugin/js/extensions/revolution.extension.migration.min.js', array('jquery'), '1.0.0', true );
	wp_enqueue_script( 'rs-navigation-js', get_template_directory_uri() . '/rs-plugin/js/extensions/revolution.extension.navigation.min.js', array('jquery'), '1.0.0', true );
	wp_enqueue_script( 'rs-parallax-js', get_template_directory_uri() . '/rs-plugin/js/extensions/revolution.extension.parallax.min.js', array('jquery'), '1.0.0', true );
	wp_enqueue_script( 'rs-slideanims-js', get_template_directory_uri() . '/rs-plugin/js/extensions/revolution.extension.slideanims.min.js', array('jquery'), '1.0.0', true );
	wp_enqueue_script( 'rs-video-js', get_template_directory_uri() . '/rs-plugin/js/extensions/revolution.extension.video.min.js', array('jquery'), '1.0.0', true );
